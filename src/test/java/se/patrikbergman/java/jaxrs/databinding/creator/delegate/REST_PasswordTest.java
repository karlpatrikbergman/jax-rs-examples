...
public class REST_PasswordTest {
	ObjectMapper mapper;
	...
	public void marshall() throws IOException {
		REST_Password restPassword =  new REST_Password("Testar99");
	...
	public void unmarshall() throws IOException {
		...
		final REST_Password restPassword = mapper.readValue(jsonString, REST_Password.class);
